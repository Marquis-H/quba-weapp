...
import { AtFab, AtFloatLayout, AtInput, AtButton } from 'taro-ui'
...
class Index extends Component {
  ...
  render() {
    const { isOpened, loves, love, tips, guessValue } = this.state
    return (
      <View className='container'>
        {
          loves.map((item, index) => {
            return (
              <Item index={index} key={index} item={item} onHandleOpen={this.onHandleOpen} onHandleLike={this.onHandleLike} />
            )
          })
        }
        <AtFloatLayout className='cai-container' isOpened={isOpened} title='猜名字' onClose={this.handleClose.bind(this)}>
